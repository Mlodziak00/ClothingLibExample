...
public class ItemInit {
    ...
    // hideHatLayer hides the players Hat Layer
    public static Item EXAMPLE_ITEM = registerItem("example_clothing", new ClothingItem(
            ExampleClothingMod.MOD_ID, "example_clothing", false, new FabricItemSettings().maxCount(1)));
